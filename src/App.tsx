...
export default function App() {
  ...
  const [messages, setMessages] = useState<ChatMessage[]>(() => {
    ...
    return [{ id: "welcome", sender: "zoya", text: "Zoya AI Active." }];
  });

  // Silent startup - no automatic audio greeting played on load.
    ...
    <div className="h-[100dvh] w-screen bg-[#050505] text-white flex flex-col items-center justify-between font-sans relative overflow-hidden m-0 p-0">
      ...
      <header className="absolute top-0 left-0 w-full flex justify-between items-center z-20 shrink-0 px-6 py-4 md:px-12 md:py-6">
        <div className="flex items-center gap-3">
          <img 
            src="/src/assets/images/zoya_cyber_logo_1780706404933.png" 
            alt="Zoya Cyber Logo" 
            className="w-10 h-10 rounded-full object-cover border border-violet-500/30 shadow-[0_0_15px_rgba(139,92,246,0.3)] bg-[#0c0d12]"
            ...
            <button
              onClick={() => {
                if (confirm("Are you sure you want to clear the chat history?")) {
                  setMessages([{ id: "welcome", sender: "zoya", text: "Zoya AI Active." }]);
                  resetZoyaSession();
                }
              }}
